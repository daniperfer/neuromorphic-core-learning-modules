...
"""
Exercise 2: Extend Exercise 1 to also ask for
the neuron type (“Pyramidal” or “Interneuron”).
...
"""
Exercise 3: Write a program that asks for
three neuron voltages (representing three connected neurons in
...
if voltage1 >= -55:
    print("Neuron 1 is Firing")
    voltage2 += 20
else:
    print("Neuron 1 is NOT firing")

if voltage2 >= -55:
    print("Neuron 2 is Firing")
    voltage3 += 20
else:
    print("Neuron 2 is NOT firing")

if voltage3 >= -55:
    print("Neuron 3 is Firing")
else:
