...
RECORDING_TIME_DEF = 60.0  # seconds
...
silent_count = sum(
    [1 for s in [n1_spikes, n2_spikes, n3_spikes, n4_spikes, n5_spikes, n6_spikes] if s == 0]
)
